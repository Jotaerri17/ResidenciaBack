...
router.patch('/:code/finish-game', roomController.handleFinishGame)
     ...
     * 
     * /rooms/{code}/rank/{round}:
     *   get:
     *     summary: Busca o ranking do round (visão do gerente)
     *     tags:
     *       - Rooms
     *     parameters:
     *       - in: path
     ...
     *         schema:
     *           type: integer
     *         description: Número do round
     *     responses:
     *       200:
     *         description: Ranking do round
     *       500:
     *         description: Erro ao buscar ranking
     *
     * /rooms/{code}/resultado/{round}:
     *   get:
     *     summary: Busca o resultado completo do round (visão do facilitador)
     *     tags:
     *       - Rooms
     *     parameters:
     *       - in: path
     ...
     *     responses:
     *       200:
     *         description: Resultado completo do round
     *       401:
